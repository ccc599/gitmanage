        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="Teacher/teacher?cmd=changeteacher">
                    ...
                    <li>
                        <a class="J_menuItem" href="Teacher/teachermanage?cmd=def">
                            <i class="fa fa-home"></i>
                    ...
                    <li>
                        <a class="J_menuItem" href="maintable/table?cmd=def">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">试卷主表</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="ClassesG/classesg">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">添加考卷</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
